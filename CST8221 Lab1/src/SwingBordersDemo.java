...
/**
 ...
 Note that a border can be painted around every JComponent object
 @version 1.19.1
...
*/
  ...
  private void createGUI(){  
    ...
    labelText = new String[]{
      "empty border", "thick empty border",
      "line border", "thick rounded line border",
      "raised bevel border", "lowered bevel border",
      "raised etched border", "lowered etched border",
      "default titled border","modified titled border",
...
*/
  public static void main(String[] args) {
     /*
       Make all components be configured by the event dispatch thread.
